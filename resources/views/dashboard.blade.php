                                ...
                                <div class="card-body">
                                    <form action="{{ route('producto.store') }}" method="POST">
                                        ...
                                        <div class="form-outline">
                                            <input type="text" id="cod_unique" name="cod_unique" class="form-control" />
                                        ...
                                        <div>
                                            ...
                                            <select type="text" class="select-form" name="sucursal">
                                        ...
                                        <br>
                                        <div>
                                            <select type="text" class="select-form" name="category">
